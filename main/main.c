/*
 * Carbon HiSLIP Instrument - ESP32 Main Application
 * 
 * Initializes WiFi, connects to network, and starts HiSLIP server
 * for remote instrument control via SCPI commands.
 */
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Initialization complete. Ready to start services.");
